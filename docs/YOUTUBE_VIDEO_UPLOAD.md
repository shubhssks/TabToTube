...
The thumbnail is `1280 x 720`, PNG, and under YouTube's desktop upload size limit.

## Recommended Title

```text
TabToTube 1.0 Quick Start - Stream Chrome Tabs to YouTube Live
```

Alternative shorter title:

```text
TabToTube Quick Start: Stream Tabs to YouTube Live
```

## Description

Copy/paste this into the YouTube description:
...
Source code, support, and issue tracker:
https://github.com/shubhssks/TabToTube
...
```text
TabToTube, YouTube Live, YouTube streaming, Chrome extension, browser streaming, tab capture, screen capture, FFmpeg, RTMP, live streaming, stream to YouTube, creator tools, local streaming, no cloud relay, Chrome tab capture, MediaRecorder, YouTube RTMP, streaming workflow, software demo, browser extension
```
...
Suggested thumbnail idea if you later regenerate it:

```text
Headline: Stream Chrome to YouTube Live
Visual: TabToTube popup + YouTube Live/RTMP cue + companion app mention
```

## YouTube Studio Fields
...
Age restriction: No
Paid promotion: No, unless there is a real sponsorship or paid placement
Altered or synthetic content: No
Language: English
Category: Science & Technology
License: Standard YouTube License
Allow embedding: Yes
Publish to subscriptions feed: No for first unlisted QA upload; Yes when publishing publicly
Visibility before store approval: Unlisted
Visibility after Chrome Web Store approval: Public
Playlist: Product demos or TabToTube, if the channel has one
...
Use this as the pinned comment after upload:

```text
Download the TabToTube Companion App here:
https://github.com/shubhssks/TabToTube/releases/latest
...
3. Select `assets/publishing/video/tabtotube-quick-start.mp4`.
